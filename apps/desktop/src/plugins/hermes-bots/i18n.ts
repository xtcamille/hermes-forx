...
const en: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update ForX Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update ForX Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older ForX',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'ForX couldn’t reach the computer this bot runs on',
...
const zh: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 ForX Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 ForX Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 ForX 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'ForX 无法连接到运行这个机器人的电脑',
