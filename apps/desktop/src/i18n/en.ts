...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want ForX to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into ForX and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into ForX.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in ForX. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in ForX',
    continue: 'Continue in ForX',
  ...
  boot: {
    ready: 'ForX Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading ForX settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote ForX backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting ForX Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'ForX stopped right after it started.',
      backendStopped: 'ForX stopped working in the background',
      restartHermes: 'Restart ForX',
      openLogs: 'Open logs',
      desktopBootFailed: "ForX couldn't start",
      gatewayConnectionLost: 'ForX lost its connection',
      ...
      gatewaySignInRequired: 'Your remote ForX signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "ForX Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "ForX' background service stopped right after starting.",
      timedOut: "ForX' background service didn't answer in time.",
      permission: "ForX couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so ForX could not start.',
      portInUse: 'Another program is using the network port ForX needs.',
      installMissing: "Part of ForX' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "ForX couldn't start",
      description:
        "ForX' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ForX backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update ForX',
    ...
    errors: {
      ...
      storageFailure: "ForX couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This ForX no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "ForX' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'ForX was updated but is still running the old version. Restart it to finish the update.',
      restartHermesFailed: "Couldn't restart ForX"
    },
    actions: {
      restartHermes: 'Restart ForX',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to ForX',
    ...
    native: {
      ...
      inputBody: 'ForX is waiting for your response.',
      turnDoneTitle: 'ForX finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `forx debug share --nous` from a terminal, or `forx debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ForX defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `ForX catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, ForX generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; ForX picks it up automatically.`,
        disabledDesc: 'Detected but turned off for ForX.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when ForX closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while ForX is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'ForX asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while ForX was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while ForX was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ForX follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and ForX can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and ForX. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let ForX spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what ForX is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen ForX, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'Uninstall ForX'
    },
    poolLimits: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The ForX runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — ForX only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart ForX',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'ForX checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ForX configuration...',
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current ForX draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets ForX detect both Command keys while another app is active. Allow ForX in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets ForX capture the frontmost app window when you use this shortcut. Allow ForX in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart ForX if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening ForX.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every ForX gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by ForX Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'ForX Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The ForX runtime managed by this app.',
      kindRemoteDesc: 'A ForX gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your ForX Cloud account.',
      kindSshDesc: 'A ForX install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers ForX manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under ForX Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the ForX Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a ForX backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way ForX was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart ForX without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private ForX backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote ForX backend.',
      ...
      cloudDesc: 'Sign in once to ForX Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'ForX Cloud',
      cloudSignIn: 'Sign in to ForX Cloud',
      cloudSignedIn: 'Signed in to ForX Cloud',
      cloudNeedsSignIn: 'Sign in to ForX Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your ForX Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'ForX Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of ForX Cloud',
      cloudSignedOutMessage: 'Cleared the ForX Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /forx.',
      probing: 'Checking how this gateway authenticates…',
      probeError: "ForX can't reach that address. Check the URL and that the other computer is running ForX — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'ForX Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ForX ${version}` : ''}`,
      ...
      sshDesc:
        'ForX is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'ForX path (optional)',
      sshHermesPathDesc: 'Full path to the remote forx binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — ForX found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — ForX runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update ForX on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to ForX. Review the exact configuration below — it comes from the link, not from ForX.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. ForX starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ForX runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point ForX at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `ForX can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let ForX browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via forx curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update ForX to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the ForX catalog${sha ? ` at pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the ForX plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable: 'Could not load the ForX plugin catalog. Check your connection and open the link again.'
    },
  ...
  starmap: {
    ...
    emptyDesc: 'As ForX builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart ForX to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update ForX to generate pets.',
      backgroundHint: 'You can close this — ForX will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ForX desktop' },
    ...
    hermesActiveSessions: (version, count) => `ForX ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "ForX couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this ForX installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. ForX creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@forx:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote ForX you point it at, instead of this computer.',
    ...
    defaultDescription: 'Used when ForX opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ForX environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'ForX did not save that model change.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ForX will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the ForX backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from ForX. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the ForX backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ForX...',
    placeholderReconnecting: 'Reconnecting to ForX…',
    ...
    voiceEngineChained: 'Speech-to-text + ForX voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to ForX)',
    ...
    attachUrlDesc: 'ForX will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating ForX…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting ForX…',
    ...
    unsupportedMessage: 'This version of ForX can’t update itself from inside the app.',
    connectionRetry:
      "ForX couldn't reach the update server. Check your internet connection and try again. If you use a remote ForX, make sure it is online.",
    gitUnusable: 'ForX could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    availableBody: 'A new version of ForX is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected ForX backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed ForX from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ForX will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the ForX desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The ForX updater takes over in its own window and reopens ForX automatically when it’s done. Please don’t reopen ForX yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ForX reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then ForX reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update ForX?',
    blockerBody:
      'ForX needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update ForX',
    foreignBlockerBody:
      'ForX can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'ForX can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'ForX is one click away',
    stayText: 'Switch to the setup profile and open Welcome to ForX whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm ForX. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'ForX needs a one-time install',
    ...
    setupChoiceTitle: 'Set up ForX Desktop',
    setupChoiceDesc:
      'Connect this app to a ForX gateway you already run, or install ForX locally on this computer.',
    connectExistingTitle: 'Connect to existing ForX',
    ...
    installLocalTitle: 'Install ForX locally',
    installLocalDesc: 'Download ForX, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart ForX Desktop and try again.',
    remoteSetupTitle: 'Connect to existing ForX',
    remoteSetupDesc: 'Enter your gateway URL. ForX Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the ForX gateway, including https:// when remote.',
    ...
    settingUpTitle: 'Setting up ForX Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of ForX is running, the internet connection dropped, or antivirus blocked the installer. Close other ForX windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. The ForX installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ForX Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ForX is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ForX…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ForX',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ForX at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ForX connects automatically',
    ...
    authorizeThere: 'Authorize ForX there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ForX there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      'Your session ended before the sign-in finished. ForX will start a new one; then sign in again whenever you\'re ready.',
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `ForX couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "ForX couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This ForX is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of ForX can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using ForX without signing in is paused for a moment. ForX will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so ForX will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "ForX couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic: "ForX couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ForX will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ForX is restarting...',
      askRestart: 'Ask ForX to restart the server',
      lookingRestart: taskId => `ForX is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ForX is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask ForX to open a page.',
      finishedRestarting: message => `ForX finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ForX could not restart the server.',
      stillWorking:
        'ForX is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ForX is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'ForX hit a problem',
        generic: "ForX couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'ForX hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so ForX could not save this conversation. Free some space, then retry.',
        endpoint: "ForX can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'ForX hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while ForX was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'ForX hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `ForX could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something ForX could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'ForX got stuck in a loop',
          body: 'The reply kept repeating the same steps, so ForX stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another ForX window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so ForX could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using ForX without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "ForX uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "ForX couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "ForX couldn't send that without signing in",
      ...
      errorToastTitle: "ForX couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHermesFolder: 'Open ForX folder',
      errorOpenHermesFolderFailed: 'Could not open the ForX folder',
    ...
    approval: {
      gatewayDisconnected:
        'ForX is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask ForX to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.forx/config.yaml). ForX won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'ForX is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'ForX needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `ForX reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and ForX types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and ForX enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ForX Desktop to use Save Image.',
    restartToSaveImages: 'Restart ForX Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "ForX couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions ForX loads when the work calls for them.'
      },
      messaging: {
        title: 'ForX away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything ForX made',
      ...
      profiles: {
        ...
        text: 'Each one is its own ForX — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
